...
if (!isset($input['session_id']) || !isset($input['session_token'])) {
...
try {
    ...
    $session = $chatManager->getSessionDetails($input['session_id'], $input['session_token']);
    ...
    error_log('Chat session details error: ' . $e->getMessage());
